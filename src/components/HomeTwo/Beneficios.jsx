        ...
        <section className='lg-beneficios-area'>
            <div className="container">
                ...
                <div className="lg-beneficios-heading">
                    ...
                    <p>Locatel A Tiempo es una membresía diseñada para que tus familiares accedan a consultas médicas ilimitadas 24/7 desde cualquier lugar. Con un equipo de especialistas siempre disponibles, este servicio de telemedicina les permite recibir atención médica sin esperas, con la comodidad y seguridad que merecen.</p>
                </div>
                ...
                <div className="lg-beneficios-content">
                    ...
                    <div className="lg-single-beneficios-content">
                        ...
                        <div>
                            ...
                            <p className="description">Acceso a médicos certificados en cualquier momento.​</p>
                        </div>
                    </div>
                     {/* single item */}
                    ...
                    <div className="lg-single-beneficios-content">
                        ...
                        <div>
                            ...
                            <p className="description">Alertas para toma de medicamentos y citas médicas.​​</p>
                        </div>
                    </div>
                     {/* single item */}
                    ...
                    <div className="lg-single-beneficios-content">
                        ...
                        <div>
                            ...
                            <p className="description">Pediatría, Medicina Interna, Nutrición y más.​​​</p>
                        </div>
                    ...
                    <div className="lg-single-beneficios-content">
                        ...
                        <div> 
                            ...
                            <p className="description">Sincronización de cuentas para manejo integral
                            de la salud familiar.​</p>
                        </div>
                    </div>
                     {/* single item */}
                    ...
                    <div className="lg-single-beneficios-content">
                        ...
                        <div>
                            ...
                            <p className="description">​Consulta y gestión del historial médico en línea.​</p>
                        </div>
                    </div>
                     {/* single item */}
